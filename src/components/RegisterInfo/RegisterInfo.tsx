import * as styles from './RegisterInfo.module.scss';
...
export const RegisterInfo = () => {
	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.info}>
				<div className={styles.title}>
					<img src={money_icon} className={`${styles.icon} ${styles['icon_money']}`} alt='ikona'/>
					<h4>płatność</h4>
				</div>
				<p className={styles.text}>
			...
			<div className={styles.info}>
				<div className={styles.title}>
					<img src={info_icon} className={`${styles.icon} ${styles['icon_info']}`} alt='ikona'/>
					<h4>informacja</h4>
				</div>
				<p className={styles.text}>
