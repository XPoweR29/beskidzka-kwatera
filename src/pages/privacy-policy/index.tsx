...
import * as styles from './privacy_policy.module.scss';
		...
		<Wrapper className={styles.wrapper}>
			<article>
				...
				<ul>
					<li>
						<p>
							<strong>Serwis</strong> - serwis internetowy "Kwatery u Zosi"
							działający pod adresem https://kwateryuzosi.pl
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							...
							osoba fizyczna "" zamieszkała w Węgierska Górka , świadcząca
				...
				<ul>
					<li>
						<p>
							...
							kontakt@kwateryuzosi.pl
						</p>
					</li>
					<li>
						<p>
							<strong>Połączenie telefoniczne</strong> - +48 607 262 643
						</p>
					</li>
					<li>
						<p>
							<strong>Formularz kontaktowy</strong> - dostępny pod adresem:
							https://www.kwateryuzosi.pl/kontakt
						</p>
					</li>
				</ul>
