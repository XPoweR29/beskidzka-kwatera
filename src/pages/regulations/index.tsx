...
import * as styles from './regulations.module.scss';
		...
		<Wrapper className={styles.wrapper}>
			<article>
				...
				<ul>
					...
					<li>
						<strong>Serwis</strong> – serwis internetowych &quot;Kwatery u
						Zosi&quot;, działających pod adresem https://kwateryuzosi.pl
					</li>
					<li>
						<strong>Usługodawca</strong> – właściciel serwisu będący osobą
						fizyczną -
					</li>
					<li>
				...
				<ul>
					...
					<li>
						...
						<ul>
							...
							<li>
								Wysyłając wiadomość na adres e-mail: kontakt@kwateryuzosi.pl
							</li>
							<li>
								Poprzez połączenie telefoniczne z numerem: +48 607 262 643
							</li>
						</ul>
